...
describe("Test the image resizing process", function () {
  ...
  //test the enpoint response
  it("Return a 404 page if wrong parameters are provided", function () {
    return __awaiter(void 0, void 0, void 0, function () {
      var res;
      return __generator(this, function (_a) {
        switch (_a.label) {
  ...
  it("Expect a resolved promise", function () {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              expectAsync(
                (0, imgResizing_1.resizeImage)()("hands", 100, 150)
              ).toBeResolved()
            ];
          case 1:
            _a.sent();
  ...
  it("Rename the new resized image", function () {
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              expect(
                (0, imgResizing_1.getResizedImagePath)()("hands", 100, 150)
              ).toEqual(
                ""
                  .concat(outputFolder, "/")
                  .concat("res_")
