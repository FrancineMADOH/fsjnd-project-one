...
describe("Test the image resizing process", function () {
    ...
    //test the enpoint response
    it("Return a 404 page if wrong parameters are provided", function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get("/api/resize?imgName=hands&imgWidth=100&imgHeight=150vccs")];
                case 1:
                    res = _a.sent();
                    expect(res.status).toBe(200);
                    return [2 /*return*/];
